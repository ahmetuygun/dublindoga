...
export class EventService {
 ...
 public addJoiner(eventId: number, joinerId: number): Observable<void> {
    const requestPayload = { eventId, joinerId };
    return this.http.post<void>(`${this.resourceUrl}/addJoiner`, requestPayload);
  }

removeJoiner(eventId: number, joinerId: number): Observable<void> {
  return this.http.delete<void>(`${this.resourceUrl}/${eventId}/joiners/${joinerId}`);
}

 approveJoiner(eventId: number, joinerId: number): Observable<void> {
    return this.http.post<void>(`${this.resourceUrl}/${eventId}/approve/${joinerId}`, {});
  }

  toRemoveFromApproved(eventId: number, joinerId: number): Observable<void> {
    return this.http.delete<void>(`${this.resourceUrl}/${eventId}/approved/${joinerId}`);
  }
}
