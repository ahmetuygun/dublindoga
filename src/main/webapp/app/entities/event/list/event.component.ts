...
@Component({
  ...
  imports: [RouterModule, FormsModule, SharedModule, FormatMediumDatePipe, SortDirective, SortByDirective, FormatMediumDatetimePipe, ItemCountComponent, HasAnyAuthorityDirective],
})
...
trackId = (index: number, item: IEvent): number => {
  return this.eventService.getEventIdentifier(item);
};
