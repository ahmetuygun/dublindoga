...
import { sampleWithRequiredData } from '../joiner.test-samples';
import { JoinerService } from '../service/joiner.service';

import { JoinerComponent } from './joiner.component';
import SpyInstance = jest.SpyInstance;

describe('Joiner Management Component', () => {
  let comp: JoinerComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(JoinerComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.joiners()[0]).toEqual(expect.objectContaining({ id: 28560 }));
  });

  describe('trackId', () => {
    it('Should forward to joinerService', () => {
      const entity = { id: 28560 };
      jest.spyOn(service, 'getJoinerIdentifier');
      const id = comp.trackId(entity);
      expect(service.getJoinerIdentifier).toHaveBeenCalledWith(entity);
